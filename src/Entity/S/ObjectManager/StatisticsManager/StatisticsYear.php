 ...
 */
#[ORM\Entity]
#[ORM\Table(name: 'object_manager_statistic_manager_year')]
class StatisticsYear extends ModelStatisticsYear
{
     ...
     * @var StatisticsMonth
     */
    #[ORM\OneToMany(targetEntity: 'App\Entity\S\ObjectManager\StatisticsManager\StatisticsMonth', cascade: ['persist', 'remove'], mappedBy: 'yearEntity')]
    protected $months;
