...
#[ORM\Table(name: 'object_manager_statistic_manager_user_monthly')]
class StatisticsMonth extends ModelStatisticsMonth
{
    /**
     * @var StatisticsYear
     */
    #[ORM\ManyToOne(targetEntity: 'App\Entity\S\ObjectManager\StatisticsManager\User\StatisticsYear', inversedBy: 'months')]
